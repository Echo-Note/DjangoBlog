...
from apps.oauth.models import OAuthConfig
from apps.oauth.oauthmanager import BaseOauthManager
...
class OauthLoginTest(TestCase):
    ...
    def test_weibo_login(self, mock_do_get, mock_do_post):
        ...
        assert weibo_app
        url = weibo_app.get_authorization_url()  # noqa: F841
    ...
    def test_google_login(self, mock_do_get, mock_do_post):
        ...
        assert google_app
        url = google_app.get_authorization_url()  # noqa: F841
        mock_do_post.return_value = json.dumps(
            {
        ...
        token = google_app.get_access_token_by_code("code")  # noqa: F841
    ...
    def test_github_login(self, mock_do_get, mock_do_post):
        ...
        token = github_app.get_access_token_by_code("code")  # noqa: F841
    ...
    def test_facebook_login(self, mock_do_get, mock_do_post):
        ...
        token = facebook_app.get_access_token_by_code("code")  # noqa: F841
    ...
    def test_qq_login(self, mock_do_get):
        ...
        token = qq_app.get_access_token_by_code("code")  # noqa: F841
