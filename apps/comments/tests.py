...
from apps.comments.templatetags.comments_tags import *  # noqa: F403
...
class CommentsTest(TransactionTestCase):
    ...
    def test_validate_comment(self):
        ...
        tree = parse_commenttree(article.comment_list(), comment)  # noqa: F405
        self.assertEqual(len(tree), 1)
        data = show_comment_item(comment, True)  # noqa: F405
