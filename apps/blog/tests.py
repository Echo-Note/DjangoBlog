...
from apps.blog.forms import BlogSearchForm
from apps.blog.models import Article, Category, Links, SideBar, Tag
from apps.blog.templatetags.blog_tags import load_articletags, load_pagination_info
...
class ArticleTest(TestCase):
    ...
    def test_validate_article(self):
        ...
        from apps.blog.templatetags.blog_tags import gravatar, gravatar_url

        u = gravatar_url("liangliangyy@gmail.com")
        u = gravatar("liangliangyy@gmail.com")  # noqa: F841
