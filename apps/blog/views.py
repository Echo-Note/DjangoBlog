...
from apps.blog.models import Article, Category, Links, LinkShowType, Tag
...
class ArticleDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        hooks.run_action(
            "after_article_body_get", article=article, request=self.request
        )
...
def page_not_found_view(request, exception, template_name="blog/error_page.html"):
    ...
    url = request.get_full_path()  # noqa: F841
    return render(
        request,
        template_name,
        {
